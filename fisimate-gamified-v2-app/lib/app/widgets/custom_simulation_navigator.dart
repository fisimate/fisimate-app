import 'package:fisimate/app/helpers/text_helper.dart';
...
class CustomSimulationNavigator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: currentSectionIndex == 0 && isOnResultPage == null
        ...
        if (currentSectionIndex != 0 && isOnResultPage == null)
          Container(
            ...
            child: BaseElevatedButton.icon(
              ...
              label: TextHelper.matchSimulationNavigationLabelByIndex(
                buttonType: ButtonNavTypeEnum.previous,
                sectionIndex: currentSectionIndex,
                quizIndex: currentQuizIndex ?? 0,
                quizLength: quizLength ?? 0,
              ),
        ...
        if (currentSectionIndex != 0 || isOnResultPage == null)
          Container(
            ...
            child: BaseElevatedButton.icon(
              ...
              label: TextHelper.matchSimulationNavigationLabelByIndex(
                buttonType: ButtonNavTypeEnum.next,
                sectionIndex: currentSectionIndex,
                quizIndex: currentQuizIndex ?? 0,
                quizLength: quizLength ?? 0,
              ),
