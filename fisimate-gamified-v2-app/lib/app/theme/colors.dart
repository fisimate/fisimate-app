...
abstract class CustomColor {
  ...
  static Color lightRedColor = const Color(0xFFFFA0A0);
  ...
  static Color lightBlueColor50 = const Color(0xFF0080FF);
  ...
  static Color lightGreenColor = const Color(0xFFB4FFB2);
  ...
  // Colors on Profile
  static Color bottomSheetItemContainer = const Color(0xFFF4F4F4);
