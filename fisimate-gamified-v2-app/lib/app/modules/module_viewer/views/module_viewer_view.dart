    ...
    switch (controller.argumentType.value) {
      case 'exam_bank':
        data = {
          ...
          'button_path': 'assets/icons/yellow_arrow_left.png',
        };
        break;
      case 'material_bank':
        data = {
          ...
          'button_path': 'assets/icons/arrow-back.png',
        };
        break;
      case 'formula_bank':
        data = {
          ...
          'button_path': 'assets/icons/blue_arrow_left.png',
        };
        break;
      case 'quiz_review':
        data = {
          'title': 'Pembahasan',
          'filePath': controller.quizFilePath,
          'color': CustomColor.bankRumus,
          'button_path': 'assets/icons/blue_arrow_left.png',
        };
        break;
