...
ExamBankModel examBankModelFromJson(String str) =>
    ExamBankModel.fromJson(json.decode(str));
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        examBanks: List<ExamBank>.from(
            json["examBanks"].map((x) => ExamBank.fromJson(x))),
      );
